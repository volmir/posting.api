...
```
$.ajax({url: 'http://posting.local/v1/posts', method: 'GET', dataType: 'json', success: function(response){console.log('response:', response)}})
$.ajax({url: 'http://posting.local/v1/posts/1', method: 'GET', dataType: 'json', success: function(response){console.log('response:', response)}})
